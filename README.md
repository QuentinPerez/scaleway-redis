# Official Redis image on Scaleway

[![Travis](https://img.shields.io/travis/scaleway/image-app-redis.svg)](https://travis-ci.org/scaleway/image-app-redis)
...
Scripts to build the official Redis image on Scaleway
